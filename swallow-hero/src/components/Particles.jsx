...
const Particles = ({
  ...
  useEffect(() => {
    ...
    // Distribute particles in a more cylindrical pattern
    for (let i = 0; i < count; i++) {
      const angle = Math.random() * Math.PI * 2;
      const radius = Math.random() * 0.8 + 0.2; // Avoid particles too close to center
      const height = (Math.random() * 2 - 1) * 1.5; // Extend vertical distribution
