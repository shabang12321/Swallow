    ...
    <div className="flex-1">
      ...
      <div className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white/60 backdrop-blur-sm p-6 rounded-xl shadow-sm hover:shadow-lg transition-shadow">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-6">
          <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 shadow-sm hover:shadow-lg transition-shadow">
