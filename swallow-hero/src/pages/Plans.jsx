    ...
    <div className="flex-1">
      ...
      <div className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl font-bold mb-4 bg-gradient-to-r from-sky-400 via-teal-400 to-emerald-400 bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {/* Secure & Flexible */}
            <div className="text-center rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-8"
              style={{ 
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-6">
          <div className="faq-card p-6 shadow-lg hover:shadow-xl transition-all duration-300"
            style={{ 
              backgroundColor: '#FFFFFF',
              isolation: 'isolate',
              position: 'relative',
          ...
          >
            ...
            <div className="relative z-2">
              ...
              <p className="text-gray-700">Yes, you can upgrade, downgrade, or cancel your plan at any time from your account settings.</p>
            </div>
          </div>
          <div className="faq-card p-6 shadow-lg hover:shadow-xl transition-all duration-300"
            style={{ 
          ...
          >
            ...
            <div className="relative z-2">
              ...
              <p className="text-gray-700">We accept all major credit cards, PayPal, and other secure payment methods.</p>
            </div>
          </div>
          <div className="faq-card p-6 shadow-lg hover:shadow-xl transition-all duration-300"
            style={{ 
          ...
          >
            ...
            <div className="relative z-2">
              ...
              <p className="text-gray-700">Yes, you can try our basic features for free to see if Swallow Hero is right for you.</p>
            </div>
          </div>
        </div>
