      ...
      <div className="py-8 sm:py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-800 dark:text-gray-200 max-w-2xl mx-auto mb-6 sm:mb-8 px-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            <div className="hidden md:block absolute top-1/2 left-0 w-full">
              <div className="h-1 bg-gradient-to-r from-sky-200 via-teal-200 to-green-200 dark:from-sky-800 dark:via-teal-800 dark:to-green-800 transform -translate-y-1/2 rounded-full shadow-sm"></div>
              <div className="h-0.5 bg-gradient-to-r from-sky-100 via-teal-100 to-green-100 dark:from-sky-700 dark:via-teal-700 dark:to-green-700 transform translate-y-0.5 blur-sm"></div>
            </div>
            
            {/* Step 1 */}
            <div className="rounded-xl p-8 shadow-lg relative transform transition-all duration-300 hover:scale-105 hover:shadow-xl border border-sky-100 dark:border-sky-800 bg-white dark:bg-gray-800" style={{ isolation: 'isolate', position: 'relative', zIndex: 1 }}>
              ...
              <div className="mt-8 text-center">
                <div className="w-20 h-20 mx-auto mb-6 bg-sky-100 dark:bg-sky-900 rounded-full flex items-center justify-center transform transition-transform duration-300 group-hover:rotate-6">
            ...
            {/* Step 2 */}
            <div className="rounded-xl p-8 shadow-lg relative transform transition-all duration-300 hover:scale-105 hover:shadow-xl border border-teal-100 dark:border-teal-800 bg-white dark:bg-gray-800" style={{ isolation: 'isolate', position: 'relative', zIndex: 1 }}>
              ...
              <div className="mt-8 text-center">
                <div className="w-20 h-20 mx-auto mb-6 bg-teal-100 dark:bg-teal-900 rounded-full flex items-center justify-center transform transition-transform duration-300 group-hover:rotate-6">
            ...
            {/* Step 3 */}
            <div className="rounded-xl p-8 shadow-lg relative transform transition-all duration-300 hover:scale-105 hover:shadow-xl border border-green-100 dark:border-green-800 bg-white dark:bg-gray-800" style={{ isolation: 'isolate', position: 'relative', zIndex: 1 }}>
              ...
              <div className="mt-8 text-center">
                <div className="w-20 h-20 mx-auto mb-6 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center transform transition-transform duration-300 group-hover:rotate-6">
