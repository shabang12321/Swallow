  ...
  return (
    <div className="mb-8">
      <div className="flex items-center gap-3 mb-6">
        <div className="p-2 rounded-lg bg-gradient-to-r from-sky-100 to-teal-100">
          {icon}
        </div>
      ...
      <div className="space-y-4">
        {faqs.map((faq, index) => (
          ...
          >
            ...
            {openIndex === index && (
              <div className="px-6 py-4 border-t border-gray-200 relative z-2 bg-gray-50">
          ...
          >
            ...
            <footer className="mt-12 pt-8 border-t border-gray-200">
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Link to="/about" className="btn-outline text-sky-600 hover:text-sky-700">
                  Learn More
                  <svg className="w-5 h-5 icon-right" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                  </svg>
